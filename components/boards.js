...
export default function Boards({ showAdd, notesData }) {
  // const notesData = [
  ...
  return (
    ...
    >
      <div
        className={`grid  ${showAdd ? 'grid-cols-3 gap-8' : 'grid-cols-2 gap-12'}   sm:grid-cols-2 lg:grid-cols-3 gap-2 p-4  justify-items-center`}
      >
